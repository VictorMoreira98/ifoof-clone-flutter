...
class CategoryItemComponent extends StatelessWidget {
  ...
  const CategoryItemComponent({Key key, this.category}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(category?.name ?? '', style: AppTypography.small(context).copyWith(color: AppColors.grey),),
        )
      ],
    );
  }
